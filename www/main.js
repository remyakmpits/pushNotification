(self["webpackChunkoneSignalPush"] = self["webpackChunkoneSignalPush"] || []).push([["main"],{
...
/* harmony import */ var onesignal_cordova_plugin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! onesignal-cordova-plugin */ 9488);
...
let AppComponent = class AppComponent {
    ...
    OneSignalInit() {
        ...
        onesignal_cordova_plugin__WEBPACK_IMPORTED_MODULE_2___default().setAppId("23d3b29e-6f83-47bf-8cb6-bd18fd71dbd7");
        onesignal_cordova_plugin__WEBPACK_IMPORTED_MODULE_2___default().setNotificationOpenedHandler(function (jsonData) {
            console.log('notificationOpenedCallback: ' + JSON.stringify(jsonData));
        });
        // iOS - Prompts the user for notification permissions.
        //    * Since this shows a generic native prompt, we recommend instead using an In-App Message to prompt for notification permission (See step 6) to better communicate to your users what notifications they will get.
        onesignal_cordova_plugin__WEBPACK_IMPORTED_MODULE_2___default().promptForPushNotificationsWithUserResponse(function (accepted) {
